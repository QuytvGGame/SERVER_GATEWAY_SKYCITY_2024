...
public class GiftItemThanhChien {
	...
	public GiftItemThanhChien(int typeId, int type, int quantity) {
		super();
		this.typeId = typeId;
		this.type = type;
	...
	public GiftItemThanhChien(int typeId, int type, int quantity, String giftId) {
		super();
		this.typeId = typeId;
		this.type = type;
		this.quantity = quantity;
	...
	public GiftItemThanhChien(GiftItemThanhChien giftItemClone) {
